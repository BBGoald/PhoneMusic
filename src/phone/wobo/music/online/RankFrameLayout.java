...
//	private LoadingDialog loading;
	...
	//private String TAG = "RankFrameLayout";
	private String TAG = "liangbang";

	public RankFrameLayout(Context context) {
		this(context, null);
		Log.d(TAG, "******instance RankFrameLayout");
		Log.d(TAG, "this= " + this.hashCode());
		Log.d(TAG, "RankFrameLayout.this= " + RankFrameLayout.this.hashCode());
...
//		loading = new LoadingDialog(mContext);
		...
		loading.show();
        Log.d(TAG, "	RankFrameLayout loading= " + loading.hashCode());//1112000800
        initView(view);
		loadData();
	}
	...
	private void loadData() {	
		...
		new Thread() {
			...
			public void run() {
				...
				Log.d(TAG, "	RankFrameLayout liangbang json= " + json);
